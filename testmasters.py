...
CHAT_ID = "@Testmasters_LC" # Bu yerdagi ko'rinmas bo'shliq olib tashlandi
...
def send_to_telegram(name, subject, corrects, total, ball):
    ...
    try:
        # data o'rniga json ishlatish ishonchliroq
...
if q_df is not None:
    ...
    if st.session_state.test_run:
        ...
        <div style="text-align: center; padding: 20px; background: rgba(255,255,255,0.1); border-radius: 15px; border: 1px solid #92FE9D;">
