...
if u_name_raw:
    ...
    if st.session_state.is_blocked:
        ...
        if st.session_state.test_run:
            ...
            st.sidebar.markdown(f"# ⏳ {rem//60:02d}:{rem%60:02d}")
...
if st.session_state.final_score is not None:
    ...
    st.success(f"### 🎉 Tabriklaymiz!\n**To'g'ri javoblar:** {res['score']} ta\n**Umumiy ballingiz:** {res['ball']} ball")
    st.link_button("🏆 Natijalar kanaliga o'tish", "https://t.me/Testmasters_LC", use_container_width=True)
