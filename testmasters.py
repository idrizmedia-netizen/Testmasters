...
def get_balanced_questions(df, subject, n_total=30):
    ...
    # Agar jami 30 ta bo'lmasa, qolganini ixtiyoriy savollar bilan to'ldiramiz
    ...
    if st.session_state.test_run:
        ...
        with st.form("quiz_form"):
            ...
            if st.form_submit_button("🏁 TESTNI YAKUNLASH"):
                # Natijalarni hisoblash va yuborish mantiqi (avvalgi koddagidek)
                ...
                # Sheet va Telegramga yozish kodi shu yerda bo'ladi...
